    ...
    >
      <div className="mx-[5%] max-w-[40rem] justify-self-start lg:ml-[5vw] lg:mr-20 lg:justify-self-end">
        <h1 className="mb-5 text-6xl font-bold md:mb-6 md:text-9xl lg:text-10xl">
          Ensure EU Compliance and Enhance Customer Trust
        </h1>
        <p className="md:text-md">
          Transform your product compliance journey with our Digital Product
          Passport software. Empower your brand by fostering transparency and
