        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-12 md:grid-cols-2 md:gap-y-16 lg:grid-cols-3">
          <div className="border border-border-primary">
            <Link href="/blog-page-2">
              ...
              <div className="px-5 py-6 md:p-6">
                ...
                <p>
                  Learn how DPPs can enhance product compliance and consumer
                  trust.
                </p>
          ...
          <div className="border border-border-primary">
            <Link href="/blog-page-1">
              ...
              <div className="px-5 py-6 md:p-6">
                ...
                <a href="#" className="mb-2 block max-w-full">
                  <h5 className="text-xl font-bold md:text-2xl">
                    The Future of Product Compliance
                  </h5>
                </a>
                <p>
                  Discover emerging trends in product compliance and digital
                  solutions.
                </p>
                <div className="mt-6 flex items-center">
                  <div className="mr-4 shrink-0">
          ...
          <div className="border border-border-primary">
            <Link href="/blog-page-3">
              ...
              <div className="px-5 py-6 md:p-6">
                ...
                <a href="#" className="mb-2 block max-w-full">
                  <h5 className="text-xl font-bold md:text-2xl">
                    Why Every Business Needs a Digital Product Passport
                  </h5>
                </a>
                <p>
                  Why Every Business Needs a Digital Product Passport
          ...
          <div className="border border-border-primary">
            <Link href="/blog-page-4">
              ...
              <div className="px-5 py-6 md:p-6">
                ...
                <a href="#" className="mb-2 block max-w-full">
                  <h5 className="text-xl font-bold md:text-2xl">
                    Empowering Consumers with Digital Product Passports
                  </h5>
                </a>
                <p>
                  Empowering Consumers with Digital Product Passports
          ...
          <div className="border border-border-primary">
            ...
            <div className="px-5 py-6 md:p-6">
              ...
              <p>
                Best practices for managing product data in a digital landscape.
              </p>
              <div className="mt-6 flex items-center">
                <div className="mr-4 shrink-0">
                  <img
